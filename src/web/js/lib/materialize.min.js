    ...
    _createClass(FormSelect, [{
      ...
      value: function _setupDropdown() {
        ...
        if (this.searchable) {
          ...
          var element = $('<li class="input-field col s12"><input type="text" class="dropDownsearch" style="margin: 5px 0px 16px 15px; width: 96%;"> <label for="first_name">'+ placeholder + '</label></li>');
